<template>
  <div class="teacher-introduction-container">
    ...
    <div class="insert" v-if="params.age || params.city"></div>
    <div class="introduce-base" v-if="params.age || params.city">
      <div class="introduce-base-list">
        ...
        <div class="introduce-base-item" v-if="params.city">
...
<style lang="scss" scoped>
  ...
  .teacher-introduction-container {
    ...
    .teacher-auth {
      ...
      .auth-list {
        ...
        .auth-item {
          ...
          .auth-icon {
            @include backgroundImg('../../assets/images/big_right.png');
            width: 30rpx;
            height: 30rpx;
